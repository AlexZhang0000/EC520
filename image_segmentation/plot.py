...
plt.figure(figsize=(10,6))
sns.lineplot(data=df_all_blur, x='epoch', y='val_miou', hue='model',
             palette={'clean':'black', 'blur_light':'green', 'blur_medium':'gold', 'blur_heavy':'red'})
plt.title("Validation mIoU - Blur Distortions")
plt.xlabel("Epoch")
plt.ylabel("Validation mIoU")
plt.grid(True)
...
plt.figure(figsize=(10,6))
sns.lineplot(data=df_all_noise, x='epoch', y='val_miou', hue='model',
             palette={'clean':'black', 'noise_light':'green', 'noise_medium':'gold', 'noise_heavy':'red'})
plt.title("Validation mIoU - Gaussian Noise")
plt.xlabel("Epoch")
plt.ylabel("Validation mIoU")
plt.grid(True)
...
plt.figure(figsize=(10,6))
sns.lineplot(data=df_all_alias, x='epoch', y='val_miou', hue='model',
             palette={'clean':'black', 'aliasing_light':'green', 'aliasing_medium':'gold', 'aliasing_heavy':'red'})
plt.title("Validation mIoU - Aliasing")
plt.xlabel("Epoch")
plt.ylabel("Validation mIoU")
plt.grid(True)
...
plt.figure(figsize=(10,6))
sns.lineplot(data=df_all_jpeg, x='epoch', y='val_miou', hue='model',
             palette={'clean':'black', 'jpeg_light':'green', 'jpeg_medium':'gold', 'jpeg_heavy':'red'})
plt.title("Validation mIoU - JPEG Compression")
plt.xlabel("Epoch")
plt.ylabel("Validation mIoU")
plt.grid(True)
